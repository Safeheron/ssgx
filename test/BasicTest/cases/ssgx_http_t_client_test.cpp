...
/**
 * @brief Test data for hoppscotch echo (echoes any request; status-only tests just need 200; validated via the default CA bundle)
 *
 */
const std::string hoppscotch_host = "https://echo.hoppscotch.io";
const uint16_t hoppscotch_port = 443;
const std::string hoppscotch_path_get = "/get";
const std::string hoppscotch_path_post = "/post";
const std::string hoppscotch_ca = "-----BEGIN CERTIFICATE-----\n"
...
TEST(HttpClientTestSuite, Constructor_HostOnly) {
    Test_Constructor_HostOnly(hoppscotch_host, hoppscotch_path_get);
...
TEST(HttpClientTestSuite, Constructor_HostPort) {
    Test_Constructor_HostPort(hoppscotch_host, hoppscotch_port, hoppscotch_path_get);
...
TEST(HttpClientTestSuite, Constructor_HostPortServerCA) {
    Test_Constructor_HostPort(hoppscotch_host, hoppscotch_port, hoppscotch_ca, hoppscotch_path_get);
...
TEST(HttpClientTestSuite, Get_PathOnly) {
    Test_Get_PathOnly(hoppscotch_host, hoppscotch_port, hoppscotch_path_get);
...
TEST(HttpClientTestSuite, Get_WithHeaders) {
    ...
    Test_Get_WithHeaders(hoppscotch_host, hoppscotch_port, hoppscotch_path_get, headers);
...
TEST(HttpClientTestSuite, Get_WithParams) {
    ...
    Test_Get_WithParams(hoppscotch_host, hoppscotch_port, hoppscotch_path_get, params);
...
TEST(HttpClientTestSuite, Get_WithParamsInPath) {
    ...
    Test_Get_PathOnly(hoppscotch_host, hoppscotch_port, hoppscotch_path_get + "?" + params_str);
...
TEST(HttpClientTestSuite, Get_WithHeadersAndParams) {
    ...
    ssgx::http_t::TypeHeaders headers = {{"header1", "value1"}, {"header2", "value2"}};
    ssgx::http_t::TypeParams params = {{"param1", "value1"}, {"param2", "value2"}};
    Test_Get_WithHeadersAndParams(hoppscotch_host, hoppscotch_port, hoppscotch_path_get, headers, params);
...
TEST(HttpClientTestSuite, Get_WithHeadersAndParamsInPath) {
    ...
    Test_Get_WithHeaders(hoppscotch_host, hoppscotch_port, hoppscotch_path_get + "?" + params_str, headers);
...
TEST(HttpClientTestSuite, Post_PathOnly) {
    Test_Post_PathOnly(hoppscotch_host, hoppscotch_port, hoppscotch_path_post);
...
TEST(HttpClientTestSuite, Post_WithHeaders) {
    ssgx::http_t::TypeHeaders headers = {{"header1", "value1"}, {"header2", "value2"}};
    Test_Post_WithHeaders(hoppscotch_host, hoppscotch_port, hoppscotch_path_post, headers);
...
TEST(HttpClientTestSuite, Post_WithBodyCharPointer) {
    ...
    Test_Post_WithBodyCharPointer(hoppscotch_host, hoppscotch_port, hoppscotch_path_post, body);
...
TEST(HttpClientTestSuite, Post_WithHeadersAndBodyCharPointer) {
    ssgx::http_t::TypeHeaders headers = {{"header1", "value1"}, {"header2", "value2"}};
    const char* body = "{\"field1\": \"value1\",\"fiedl2\": 1000}";
    Test_Post_WithHeadersAndBodyCharPointer(hoppscotch_host, hoppscotch_port, hoppscotch_path_post, headers, body);
...
TEST(HttpClientTestSuite, Post_WithBodyString) {
    ...
    Test_Post_WithBodyString(hoppscotch_host, hoppscotch_port, hoppscotch_path_post, body);
...
TEST(HttpClientTestSuite, Post_WithHeadersAndBodyString) {
    ssgx::http_t::TypeHeaders headers = {{"header1", "value1"}, {"header2", "value2"}};
    const std::string body = "{\"field1\": \"value1\",\"fiedl2\": 1000}";
    Test_Post_WithHeadersAndBodyString(hoppscotch_host, hoppscotch_port, hoppscotch_path_post, headers, body);
...
TEST(HttpClientTestSuite, ErrorHandling_InvalidUrl) {
    ...
    ssgx::http_t::Result result = client.Get(hoppscotch_path_get);
    ASSERT_TRUE(!result);
    ...
    result = client.Get(hoppscotch_path_get);
    ASSERT_TRUE(!result);
    ASSERT_EQ(result.error().code(), ssgx::http_t::ErrorCode::InvalidUrl);
    ssgx::utils_t::Printf("%s\n", result.error().message().c_str());
}
...
TEST(HttpClientTestSuite, ErrorHandling_InvalidHost) {
    const std::string invalid_host = "https://www.invalid.com";
...
TEST(HttpClientTestSuite, ErrorHandling_InvalidPath) {
    ...
    ssgx::http_t::Client client(hoppscotch_host);
